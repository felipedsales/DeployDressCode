    ...
    return (
        <Container maxWidth="sm" className="topo2">
            <form onSubmit={onSubmit}>
                ...
                <TextField value={produto.cor} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedProduto(e)} id="cor" label="cor" variant="outlined" name="cor" margin="normal" fullWidth />
